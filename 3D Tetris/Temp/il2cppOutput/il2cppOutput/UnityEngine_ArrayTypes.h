...
// UnityEngine.Transform[,,]
struct TransformU5BU2CU2CU5D_t3681339878  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) Transform_t284553113 * m_Items[1];
...
public:
	...
	inline Transform_t284553113 * GetAt(il2cpp_array_size_t i, il2cpp_array_size_t j, il2cpp_array_size_t k) const
	{
		il2cpp_array_size_t index = (i * bounds[1].length + j) * bounds[2].length + k;
		return m_Items[index];
	}
	inline Transform_t284553113 ** GetAddressAt(il2cpp_array_size_t i, il2cpp_array_size_t j, il2cpp_array_size_t k)
	{
		il2cpp_array_size_t index = (i * bounds[1].length + j) * bounds[2].length + k;
		return m_Items + index;
	}
	inline void SetAt(il2cpp_array_size_t i, il2cpp_array_size_t j, il2cpp_array_size_t k, Transform_t284553113 * value)
	{
		il2cpp_array_size_t index = (i * bounds[1].length + j) * bounds[2].length + k;
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
